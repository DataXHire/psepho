...
export const metadata: Metadata = {
  title: 'psepho — Collective Decision Platform',
  description: 'Civic consensus and dynamic collective decision platform with verifiable integrity and deep demographic analytics.',
};
